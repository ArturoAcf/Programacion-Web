<!--
  Práctica 2 - Fichero 'seccion1-3.php'
...
<html lang="es">
  <head>
    <meta charset="utf-8">
    <title> seccion1-3 - Telescopios </title>
  ...
  <body>
    <header>
      ...
      <aside>
        ...
        if(!empty($_SESSION['Usuario'])){
            ...
            <a class="enlace" href="procesar_logout.php" id="u2"> Cerrar admin &nbsp </a>';
    ...
    <section class="main">
      ...
      <article class="Producto">
        <a href="item1-2.php" target="_blank"> <img src="Imagenes/t3.png" alt="Telescopio"> </a>
        <a href="item1-2.php" id="enlace" target="_blank"> Telescopio Schmidt-Cassegrain <br> SC 203/2032 </a>
